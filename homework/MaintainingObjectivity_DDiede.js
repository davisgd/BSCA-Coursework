 ...
 */
 ...
 metallica.addBandmate = function addBandmate(name,instrument){
 ...
 * instruments like so:
 */
 metallica.addBandmate("Lames Hatfeet","Vocals");
 metallica.addBandmate("Mars Ursa","Drums");
 ...
 */
 ...
 metallica.removeBandmate = function removeBandmate(name){
   delete this[name];
 }
 ...
 */
 ...
 metallica.removeBandmate("Lames Hatfeet");
 console.log("My band is now:",metallica);
 ...
 * call as below:
 */
 metallica.bandPlay = function bandPlay(){
